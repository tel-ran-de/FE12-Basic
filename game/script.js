...
const monster1 = createMonster('images/monster.png', canvas);
...
const gameCycle = function() {
    ...
    ||(distanceBetweenTwoPoints(hero.x, monster1.x, hero.y, monster1.y) < hero.image.width / 2 + monster1.image.width / 2)) {
        score.wins++;
        hero.reset();
        monster1.reset();
        monster.reset();
